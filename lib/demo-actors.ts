...
export const DEMO_ACTORS: Actor[] = [
  { ...base, id: "demo-seq-01", name: "SEQ-NYC-01", kind: "sequencer", status: "online", host: "10.42.0.10", port: 30001, className: "Sequencer", sequencerRole: "Primary", latency: "3.4 μs", session: "2607171725", sessionStarted: "17 Jul 2026 · 17:25", actions: ["status", "showAccounts", "rollSession", "list"] },
  { ...base, id: "demo-backup-01", name: "SEQ-NYC-02", kind: "backup-sequencer", status: "standby", host: "10.42.0.11", port: 30001, className: "Sequencer", sequencerRole: "Backup", latency: "4.1 μs", session: "2607171725", sessionStarted: "17 Jul 2026 · 17:25", actions: ["status", "activate", "showAccounts", "list"] },
  ...
  { ...base, id: "demo-rpl-03", name: "RPL-WEST-01", kind: "replayer", status: "warning", host: "10.42.2.20", port: 30002, className: "NetworkReplayer", cluster: "WEST", latency: "18 msg lag", session: "catching up", actions: ["status", "open", "close", "list"] },
  ...
  { ...base, id: "demo-node-02", name: "RISK-ENGINE", kind: "application", status: "online", host: "10.42.4.42", port: 30004, account: "risk", className: "RiskEngineNode", latency: "1.2M msg", session: "subscribed", actions: ["status", "reset", "list"] },
  { ...base, id: "demo-node-03", name: "MARKET-DATA", kind: "node", status: "offline", host: "10.42.4.43", port: 30004, account: "market-data", className: "MarketDataNode", latency: "—", session: "disconnected", actions: ["status", "list"] },
];
