...
- System Pulse shows Online and Offline counts alongside Closed, Rewinding, Active, Inactive, and Disconnected counts using their established state colors. Its connected-to-Sequencer total includes only Online actors that are neither Closed nor Disconnected; use singular “Actor” when a headline count is one.
