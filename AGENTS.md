...
- Give every Offline actor card a visible background of thin diagonal coral-red stripes in addition to its red connectivity dot; keep Online actor cards on the normal unpatterned panel background.
