...
- `actors` stores endpoint, discovered identity, type, Online/Offline connectivity, the separate operational state, actions, cached session data, and timestamps. Host plus port is unique.
